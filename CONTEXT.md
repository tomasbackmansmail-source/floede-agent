...
- Sido-QC-notis (2026-06-02): en befintlig annual_report-rad på 400 000 kr ligger under ci-annualreport.json numeric_ranges.amount_sek.min = 1 000 000. QC bör flagga det. Ej brådskande.
- Stockholm-täckning begränsad (2026-06-02): endast fastighetsnämnden har annual_report-källa. Saknas: Stockholmshem, Familjebostäder, SISAB, Micasa, exploateringsnämnden, stadsbyggnadsnämnden. Egen diskussion med CTO CI om onboarding-ordning om/när Stockholm-spåret prioriteras.
- Kommunal investeringskälla (Fas 0, se Senaste besluten 2026-06-02): väntar på CTO CI-prio. Bollen hos CTO CI, ingen Engine-uppgift.
